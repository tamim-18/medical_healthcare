        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="flex flex-col justify-center space-y-6">
            <div className="space-y-4">
              ...
              >
                Breaking <span className="gradient-text">Language Barriers</span> in Healthcare
              </motion.h1>
              <motion.p 
              ...
              >
                Real-time voice translation for medical professionals and patients. 
                Communicate clearly and accurately across languages.
              </motion.p>
            </div>
            <motion.div 
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              <div className="grid gap-4 md:gap-6">
                ...
                >
                  ...
                  <p className="text-muted-foreground">Support for major languages worldwide</p>
                </motion.div>
                <motion.div 
                  className="rounded-xl glass-card p-6 shadow-lg"
                  whileHover={{ y: -5, transition: { duration: 0.2 } }}
                >
                  ...
                  <p className="text-muted-foreground">Instant voice-to-text translation</p>
                </motion.div>
              </div>
              <div className="grid gap-4 md:gap-6 mt-8">
                ...
                >
                  ...
                  <p className="text-muted-foreground">Listen to translated text with natural voices</p>
                </motion.div>
                <motion.div 
                  className="rounded-xl glass-card p-6 shadow-lg"
                  whileHover={{ y: -5, transition: { duration: 0.2 } }}
                >
                  ...
                  <p className="text-muted-foreground">Optimized for medical terminology</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
